...
public sealed class R17FindingTriageSourceTests
{
    ...
    public void MaintenanceViewShowsThreeImpactGroupsAndEvidenceTimeWithoutReplacingTheExistingGrid()
    {
        ...
        Assert.Contains("SelectedFinding.EvidenceTimeRelativeDisplay", view, StringComparison.Ordinal);
        Assert.Contains("SelectedFinding.EvidenceTimeFullDisplay", view, StringComparison.Ordinal);
