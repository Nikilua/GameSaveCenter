...
- 构建提交：`63f4b2d`。
- 完整程序集身份：`0.6.73+63f4b2d54d0ff69f824a167ac3d62c070c32bf37`。插件、Worker、Core、Contracts 的六份程序集身份由 `scripts/package.ps1` 逐一校验并一致；本包包含滚动锚点、浅色主题背景/云端筛选文字修复、首页活动内容、云端整卡导航和顶部复合按钮显示修复，以及实际 WPF 点击行为测试。
...
两个文件大小均为 `43,837,982` 字节，SHA-256 均为：

`83FC0C96476B58FD5DC8AA3E97E850B12BB77EC06A5739DE361EA96ACDC17869`
