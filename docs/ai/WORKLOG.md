...
- Q25-01 补足真实受控基准：`LargeLibraryPerformanceTests` 对 2000 项搜索路径先预热 5 次，再采样 30 次并报告 p50/p95/max=198/201/201 ms；Q25-01 账本改为自动验证通过、宿主页面导航待验。Q25-08 的临时产物清理、账本同步、中文提交和推送已完成。
