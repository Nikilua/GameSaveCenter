...
- 重新运行 `validate-source.py`、`check-xaml.ps1`、WPF 静态审查和 `scripts/render-qa.ps1 -Configuration Release -Output .tmp/ui-prompt-qa-final-20260913`；构建与 XAML 为 0 error，RenderHarness `render-qa OK`，覆盖双主题、1040×700～3840×2160、多页面、状态夹具、滚动、缩放恢复和性能探针。
