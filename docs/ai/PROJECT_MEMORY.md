...
- 当前自动化基线为 Core `54/54`、Worker `167/167`、Playnite `217/217`，Release 构建 0 warnings / 0 errors；source、XAML、WPF 静态门禁与 `render-qa` 通过。真实开发安装已成功，Playnite 与 Worker 启动日志正常。
