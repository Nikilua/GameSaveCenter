...
## 当前事实覆盖（2026-08-14 Layer A 收口、Layer B 13 项与 Layer C 前 7 项）
...
- 当前自动化基线为 Core `59/59`、Worker `182/182`、Playnite `225/225`，Release 构建 0 warnings / 0 errors；source、XAML、WPF 静态门禁与 `render-qa` 通过。真实开发安装已成功，Playnite 与 Worker 启动日志正常。
