...
- 候选包沿用仓库公共版本 `0.6.73`，不因连续开发阶段随意升版本；插件、Worker、Core、Contracts 使用同一构建身份 `0.6.73+d6feda6e1d96ed7092a61ab277810f9b7bfafca9`。
- 候选 `.pext`/`.zip` 已由 `scripts/package.ps1` 在隔离输出中生成，Worker 为 self-contained `win-x64`，两个包的 SHA-256 均为 `0D347768AD6AE08CA05CAED61A133B1B00C33F70078F5AC88AFAD19E722A0303`。
