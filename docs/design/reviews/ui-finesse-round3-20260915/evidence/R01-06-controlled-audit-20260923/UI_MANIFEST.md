...
- Button | HeaderBackButton | Command={Binding ReturnToNavigationSourceCommand} | Style={DynamicResource GscWpfUiContextButton}
- Button | GameContextButton | Style={DynamicResource GscRedesignGameContextButton}
- Button | HeaderKeyboardHelpButton | Style={DynamicResource GscIconOnlyToolbarButton}
...
- TextBox | SidebarProductionVersionText | Style={DynamicResource GscWpfUiTechnicalTextBox}
...
- Border | {Binding Initials}
- Border | FooterSurface
- Button | GameSearchClearButton
- ListBox | PickerList
- TextBlock | 搜索游戏
- TextBlock | {Binding Initials}
- TextBlock | 
- TextBlock | 
...
- TextBox | {Binding OldPathDisplay, Mode=OneWay}
- TextBox | {Binding NewPathDisplay, Mode=OneWay}
...
- Border | 批量路径迁移 | Style={DynamicResource GscRedesignSubCard}
- Button |  | Command={Binding DataContext.OpenSelectedFindingNavigationCommand}
- Button |  | Command={Binding DataContext.LoadMoreRetentionQuarantineCommand}
...
- Button |  | Command={Binding ClearCloudTransferFiltersCommand}
- Button | CloudTransferCompactDetailsButton | Style={DynamicResource GscWpfUiSecondaryButton}
- Button |  | Command={Binding RefreshCloudTransfersCommand} | Style={DynamicResource GscWpfUiSecondaryButton}
- Button |  | Command={Binding OpenMaintenanceCommand}
- Button | 校验远端内容 | Command={Binding VerifyCloudTransferCommand} | Style={DynamicResource GscWpfUiPrimaryActionButton}
- Button | 重试上传 | Command={Binding RetryCloudUploadCommand} | Style={DynamicResource GscWpfUiToolbarButton}
...
- ComboBox | {Binding Display} | Style={DynamicResource GscWpfUiComboBox}
- ComboBox | {Binding Display} | Style={DynamicResource GscWpfUiComboBox}
- TextBox | {Binding CloudTransferGameFilter, Mode=TwoWay, UpdateSourceTrigger=PropertyChanged} | Style={DynamicResource GscWpfUiTextBox}
- TextBox | {Binding CloudTransferSourceDeviceFilter, Mode=TwoWay, UpdateSourceTrigger=PropertyChanged} | Style={DynamicResource GscWpfUiTextBox}
...
- Border | CloudTransferStaleBanner
- Border | 队列详情 | Style={DynamicResource GscRedesignSectionCard}
- Border | {Binding SelectedCloudTransfer.FailureCategoryDisplay}
...
- TabItem | 待处理
- TextBlock | {Binding CloudTransferEmptyStateMessage, Mode=OneWay}
...
- Button |  | Command={Binding CancelRemoteBackupStageCommand}
...
- Border | 冲突决策 | Style={DynamicResource GscRedesignSectionCard}
- Button |  | Command={Binding CancelRemoteBackupStageCommand}
- ProgressBar | 
- ScrollViewer | MaintenanceDeviceInspectorScrollViewer | Style={DynamicResource GscInspectorScrollViewer}
- TabItem | 多设备云目录
- TextBlock | 暂无设备冲突记录。
...
- Button |  | Command={Binding DataContext.OpenStorageGameCommand} | Style={DynamicResource GscWpfUiContextButton}
- Button |  | Command={Binding DataContext.OpenStorageBackupCommand} | Style={DynamicResource GscWpfUiContextButton}
...
- Button |  | Command={Binding RenameMediaFilterPresetCommand} | Style={DynamicResource GscWpfUiSecondaryButton}
- Button |  | Command={Binding DeleteMediaFilterPresetCommand} | Style={DynamicResource GscWpfUiSecondaryButton}
- Button |  | Command={Binding OpenMaintenanceCommand}
...
- Button | 忽略所选 | Command={Binding IgnoreInboxMediaBatchCommand} | Style={DynamicResource GscWpfUiActionButton}
...
- Button |  | Command={Binding RetryFailedMediaInboxBatchCommand} | Style={DynamicResource GscWpfUiSecondaryButton}
...
- Button |  | Command={Binding UndoMediaClassificationCommand} | Style={DynamicResource GscWpfUiSecondaryButton}
- Button | 确认归类 | Command={Binding AssignInboxMediaCommand} | Style={DynamicResource GscWpfUiPrimaryActionButton}
- Button | 忽略并保留副本 | Command={Binding IgnoreInboxMediaCommand} | Style={DynamicResource GscWpfUiActionButton}
- Button | 恢复到待归类 | Command={Binding RestoreIgnoredMediaBatchCommand}
...
- ComboBox |  | Style={DynamicResource GscWpfUiComboBox}
- TextBox | MediaFilterPresetNameBox | Style={DynamicResource GscWpfUiTextBox}
...
- Border | MediaInboxAvailabilityBand | Style={DynamicResource GscActionAvailabilityHintBubble}
- Border | {Binding MediaInboxBatchFailureSummary}
...
- TextBlock | 
- TextBlock | 待判断：没有可核实的来源规则、游戏会话、进程映射或文件名依据。
...
- Button |  | Command={Binding CopyPathCommand} | Style={DynamicResource GscWpfUiActionButton}
- Button |  | Command={Binding PreviousMediaCommand} | Style={DynamicResource GscWpfUiSecondaryButton}
- Button |  | Command={Binding NextMediaCommand} | Style={DynamicResource GscWpfUiSecondaryButton}
...
- TextBlock | 录像
- TextBlock | ★
- TextBlock | {Binding MediaDetailsStateMessage, Mode=OneWay}
- TextBlock | 
- TextBlock | {Binding PreviewDimensions, ElementName=MediaSelectedPreviewImage}
...
- Button |  | Command={Binding ReloadMediaDuplicateGroupsCommand} | Style={DynamicResource GscWpfUiSecondaryButton}
...
- Border | {Binding ConfidenceDisplay} | Style={StaticResource MediaTableFrame}
- ScrollViewer | MediaDuplicatePageScrollViewer | Style={DynamicResource GscPageScrollViewer}
- TabItem | 当前游戏媒体重复识别
- TextBlock | 当前游戏没有可核实的重复组。
...
- Button |  | Command={Binding PreviewMediaSourceCommand} | Style={DynamicResource GscWpfUiPrimaryActionButton}
- Button |  | Command={Binding AddMediaSourceCommand} | Style={DynamicResource GscWpfUiSecondaryButton}
...
- Button | 立即备份 | Command={Binding BackupSelectedCommand} | Style={DynamicResource GscWpfUiCompactButton}
...
- Button | {Binding GameName, Mode=OneWay} | Command={Binding DataContext.OpenRecentAccessCommand} | Style={StaticResource OverviewActivityRowButton}
- Button |  | Command={Binding RefreshCommand} | Style={DynamicResource GscWpfUiCompactButton}
...
- Border |  | Style={DynamicResource GscRedesignContextPill}
- Border | {Binding OverviewWarningGamesDisplay, Mode=OneWay} | Style={DynamicResource GscRedesignContextPill}
- Border | OverviewStatStrip | Style={DynamicResource GscRedesignSectionCard}
- Border | {Binding OverviewMatchedGamesDisplay, Mode=OneWay} | Style={StaticResource OverviewStatCard}
- Border | {Binding OverviewWarningGamesDisplay, Mode=OneWay} | Style={StaticResource OverviewStatCard}
- Border | OverviewRecentAccessCard | Style={StaticResource OverviewReadingCard}
- Border | {Binding GameName, Mode=OneWay} | Style={StaticResource OverviewActivityFrame}
...
- TextBlock | 
- TextBlock | 
- TextBlock | {Binding OverviewWarningGamesDisplay, Mode=OneWay}
- TextBlock | 无需处理
- TextBlock | 暂无最近访问
选择游戏并进入工作区后会显示在这里。
- TextBlock | 暂无任务记录
...
- Button |  | Command={Binding RetrySelectedGameCloudUploadCommand}
- Button |  | Command={Binding ClearBackupHistoryRangeCommand} | Style={DynamicResource GscWpfUiCompactButton}
- Button |  | Command={Binding JumpToRecentBackupCommand} | Style={DynamicResource GscWpfUiCompactButton}
- Button |  | Command={Binding JumpToEarlierBackupCommand} | Style={DynamicResource GscWpfUiCompactButton}
- Button | 预览备份 | Command={Binding PreviewBackupCommand} | Style={DynamicResource GscWpfUiCompactButton}
- Button | 立即扫描 | Command={Binding DetectPathsCommand} | Style={DynamicResource GscWpfUiCompactButton}
- Button | 重新校验 | Command={Binding ValidateCommand} | Style={DynamicResource GscWpfUiCompactButton}
- Button | 重新加载详情 | Command={Binding LoadDetailsCommand} | Style={DynamicResource GscWpfUiCompactButton}
...
- Button | 验证可恢复性 | Command={Binding ValidateRestoreReadinessCommand} | Style={DynamicResource GscWpfUiActionButton}
- Button |  | Command={Binding UpdateBackupMetadataCommand} | Style={DynamicResource GscWpfUiPrimaryActionButton}
- Button |  | Command={Binding CancelBackupMetadataCommand} | Style={DynamicResource GscWpfUiActionButton}
- Button |  | Command={Binding CompareBackupCommand} | Style={DynamicResource GscWpfUiActionButton}
- Button | 安全恢复 | Command={Binding RestoreCommand} | Style={DynamicResource GscWpfUiDangerActionButton}
- Button | 撤销最近恢复 | Command={Binding UndoRestoreCommand} | Style={DynamicResource GscWpfUiContextButton}
- CheckBox |  | Style={DynamicResource GscCheckBox}
- ComboBox |  | Style={DynamicResource GscWpfUiFilterComboBox}
...
- Border | SaveBackupPreviewCard
- Border | SaveBackupResultCard
- Border | {Binding RetentionProtectionGlyphDisplay, Mode=OneWay}
...
- Button | 立即备份 | Command={Binding BackupSelectedCommand} | Style={DynamicResource GscWpfUiPrimaryActionButton}
- Button |  | Command={Binding CancelPolicyDraftCommand} | Style={DynamicResource GscWpfUiActionButton}
...
- Button |  | Command={Binding ApplyPolicyTemplateBatchCommand} | Style={DynamicResource GscWpfUiPrimaryActionButton}
- Button |  | Command={Binding DataContext.RetryPolicyTemplateBatchItemCommand}
...
- TextBox |  | Style={StaticResource GscNumericFieldInput}
- TextBox |  | Style={StaticResource GscNumericFieldInput}
- TextBox | {Binding PolicyTemplateBatchSearchText, UpdateSourceTrigger=PropertyChanged} | Style={DynamicResource GscWpfUiTextBox}
...
- Border | SavePolicyTemplatesCard | Style={DynamicResource GscReadingCardStyle}
- Border | 最近批量结果
- Button |  | Command={Binding DataContext.RetryPolicyTemplateBatchItemCommand}
- Expander | 只处理明确勾选的目标；当前筛选只影响显示，不会自动选择全部游戏。 | Style={StaticResource GscDisclosureCard}
- ItemsControl | {Binding GameName}
- ScrollViewer | 备份自动化 | Style={DynamicResource GscPageScrollViewer}
- ScrollViewer | {Binding GameName} | Style={DynamicResource GscInspectorScrollViewer}
- TabItem | 备份自动化
- TextBlock | 
...
- Button |  | Command={Binding SwapCompareBackupCommand} | Style={DynamicResource GscWpfUiCompactButton}
- Button |  | Command={Binding ClearDiffPathFiltersCommand} | Style={DynamicResource GscWpfUiCompactButton}
- Button |  | Command={Binding DataContext.CopyPathCommand} | Style={DynamicResource GscWpfUiCompactButton}
- Button |  | Command={Binding DataContext.CopyPathCommand} | Style={DynamicResource GscWpfUiCompactButton}
- Button |  | Command={Binding DataContext.CopyPathCommand} | Style={DynamicResource GscWpfUiCompactButton}
- Button |  | Command={Binding LoadMoreDiffPathsCommand} | Style={DynamicResource GscWpfUiActionButton}
- Button |  | Command={Binding PreviewRetentionCommand} | Style={DynamicResource GscIconOnlyButtonBase}
- ComboBox | {Binding ComparisonRelativeDisplay, Mode=OneWay} | Style={DynamicResource GscWpfUiComboBox}
- ComboBox | {Binding ComparisonRelativeDisplay, Mode=OneWay} | Style={DynamicResource GscWpfUiComboBox}
- ComboBox |  | Style={DynamicResource GscWpfUiComboBox}
- TextBox | {Binding DiffPathSearchText, Mode=TwoWay, UpdateSourceTrigger=PropertyChanged} | Style={DynamicResource GscWpfUiTextBox}
- TextBox | {Binding ., Mode=OneWay} | Style={StaticResource GscWpfUiPathDetailTextBox}
- TextBox | {Binding ., Mode=OneWay} | Style={StaticResource GscWpfUiPathDetailTextBox}
- TextBox | {Binding ., Mode=OneWay} | Style={StaticResource GscWpfUiPathDetailTextBox}
...
- Button | TaskFilterPresetApplyButton | Command={Binding ApplyTaskFilterPresetCommand} | Style={DynamicResource GscWpfUiActionButton}
- Button |  | Command={Binding SaveTaskFilterPresetCommand} | Style={DynamicResource GscWpfUiSecondaryButton}
- Button |  | Command={Binding RenameTaskFilterPresetCommand} | Style={DynamicResource GscWpfUiSecondaryButton}
- Button |  | Command={Binding DeleteTaskFilterPresetCommand} | Style={DynamicResource GscWpfUiSecondaryButton}
- Button |  | Command={Binding ClearTaskNavigationContextCommand} | Style={DynamicResource GscWpfUiActionButton}
...
- Button |  | Command={Binding OpenSelectedTaskGameCommand} | Style={DynamicResource GscWpfUiContextButton}
...
- Button | {Binding KindDisplay} | Command={Binding DataContext.OpenSelectedTaskSourceCommand} | Style={DynamicResource GscWpfUiContextButton}
...
- ComboBox | TaskFilterPresetComboBox | Style={DynamicResource GscWpfUiFilterComboBox}
...
- TextBox | TaskFilterPresetNameBox | Style={DynamicResource GscWpfUiTextBox}
- TextBox | {Binding SelectedTask.SafeDetailMessage, Mode=OneWay} | Style={DynamicResource GscWpfUiTextBox}
...
- Border | TaskNavigationSourceBanner
...
- Border | TaskRestoreReportCard
- Border | TaskDetailCard
- Border | TaskInspectorErrorCard
- Border | TaskProgressTelemetryCard
- Border | TaskCancellationStateCard
- Border | TaskTimelineCard
- Border | TaskSourceReferenceCard
- Button | 
- Button | TaskClearFiltersButton | Command={Binding ClearTaskFiltersCommand}
- Button |  | Command={Binding LoadMoreTasksCommand}
...
- Button |  | Style={StaticResource GscWpfUiSecondaryButton}
- Button |  | Style={StaticResource GscWpfUiPrimaryButton}
- Button |  | Style={StaticResource GscWpfUiToolbarButton}
- Button |  | Style={StaticResource GscWpfUiSecondaryButton}
- Button |  | Style={StaticResource GscWpfUiToolbarButton}
- Button |  | Style={StaticResource GscWpfUiToolbarButton}
- Button |  | Style={StaticResource GscWpfUiToolbarButton}
...
- TextBox | SettingsSearchTextBox | Style={StaticResource GscWpfUiTextBox}
