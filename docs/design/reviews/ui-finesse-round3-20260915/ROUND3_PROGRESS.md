...
| --- | --- | --- | --- | --- | --- | --- | --- |
| R00-01 | 按压合成算法 | 代码完成待验收 | a95e900 | `dotnet test` 定向 5/5；同时覆盖 88 个状态样本 | 双主题受控 WPF `finesseprobe` 待 clean-tree 重跑；不代替真实按压/屏幕帧 | 算法/资源计算，不适用真实宿主性能签收 | [R00-01/02 证据](evidence/R00-01-02-CONTRAST-SCALE-20260916.md)；clean-tree 重跑后回填 |
| R00-02 | 组合缩放复用 | 代码完成待验收 | a95e900 | 1000 次组合树复用测试通过；定向 5/5 | 冻结组合树受控 STA WPF 通过；真实宿主呈现仍未验 | 变换树辅助不适用库性能签收；不宣称物理呈现 | [R00-01/02 证据](evidence/R00-01-02-CONTRAST-SCALE-20260916.md)；继续补 R08-08 可变共享隔离 |
| R00-03 | 动画结束基值 | 待开始 | — | 待验 | 待验 | 待定适用性 | 先核对最新实现及对应 Q 项 |
| R00-04 | 搜索基准真实性 | 待开始 | — | 待验 | 待验 | 待定适用性 | 先核对最新实现及对应 Q 项 |
| R00-05 | 上下文禁用透明度 | 待开始 | — | 待验 | 待验 | 待定适用性 | 先核对最新实现及对应 Q 项 |
