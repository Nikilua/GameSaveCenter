...
| Q18 | GscMotion token、资源 Host override、冻结 Transform 克隆、重入时当前值接管、完成态时钟清理、卸载释放、系统动画热变更和 reduced-motion 分支 | [`Q18-01-MOTION-HOST-20260915.md`](q13-q25/Q18-01-MOTION-HOST-20260915.md)、[`Q18-03-MOTION-REENTRY-20260915.md`](q13-q25/Q18-03-MOTION-REENTRY-20260915.md)、[`Q18-04-07-MOTION-CLEANUP-20260915.md`](q13-q25/Q18-04-07-MOTION-CLEANUP-20260915.md)、[`Q18-05-MOTION-HOT-CHANGE-20260915.md`](q13-q25/Q18-05-MOTION-HOT-CHANGE-20260915.md)、[`Q18-07-MOTION-CYCLE-20260915.md`](q13-q25/Q18-07-MOTION-CYCLE-20260915.md)；`UiFinesseFoundationTests`、`WpfUiResourceDictionaryTests`、`ProductionShellChromeSourceTests`、`UiFinesseRound2ControlSourceTests`；`8dfe7fa` 锁定真实视觉宿主时长解析，`4414f05` 锁定完成/取消/卸载清理和 Toast 逐卡释放，`68b49a1` 新增通用 STA WPF Window 终态回归，`39e37b1` 新增生产侧栏完成/窗口关闭卸载回归并修正位移归零，`dc1dd67` 新增双主题运行中切换禁用探针，`0815871` 新增双主题各 100 次 Loaded/Unloaded 壳层循环，`bdb99b9` 新增双主题当前值接管探针 | 受控当前值接管、运行中切换与壳层 100 次生命周期已取得证据；真实 Windows 偏好通知、Dashboard VM/Worker 订阅、Playnite 宿主窗口关闭、Rendering/ETW 生命周期、快速输入和宿主像素仍待宿主/性能工具复核 |
