...
> 2026-09-09 L30 已完成候选安装包与升级/回退说明：公共版本保持 `0.6.73`，六份程序集身份同源为 `0.6.73+d6feda6e1d96ed7092a61ab277810f9b7bfafca9`；Worker `win-x64` self-contained；`.pext`/`.zip` SHA-256 均为 `0D347768AD6AE08CA05CAED61A133B1B00C33F70078F5AC88AFAD19E722A0303`。隔离迁移/重复初始化定向 `14/14`，未安装真实 Playnite。
