...
> 2026-09-23 当前交接：工作分支 main，HEAD f55dce61adba84fec96c3e5434e5a8c1e3fa7132；合并 codex/ui-finesse-round2 后保留 main 的后续历史，工作树没有切回 feature。R02-02 的 RenderHarness 加载生命周期修正已并入。R18-04 当前 main 测试为专测 1/1、相关四类行为回归 23/23 且 0 skip；Task 2k/10k/20k 最大容器/可见 9/7，Media Inbox 14/14/14、有限 UI 窗口 2,000。当前 main 一轮 Media 20k 滚动出现 0.652ms 单样本，原样保留，不能概括为所有样本约 0.03ms；此前 testhost 退出清理曾打印 TextServicesHost InvalidComObjectException，xUnit 成功且 exit 0，根因未查明。本轮证据只来自合成 DTO、隔离 STA WPF 和逻辑 DIP。下一步继续收口 R00/R01 main 审计与 freshness 证据，再推进依赖满足的 Q/R。真实 Playnite/物理 DPI/跨屏、UIA/IME、presented frame、ETW 和宿主性能仍未验。详见 design/reviews/ui-finesse-round3-20260915/evidence/R18-04-TABLE-CONTAINER-BUDGET-RECHECK-20260923.md。
